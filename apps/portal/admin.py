...
class TwilioAccountAdmin(admin.ModelAdmin):
    ...
    search_fields = ["user", "twilio_account_sid", "twilio_auth_token", 'websocket_id']


@admin.register(PhoneNumber)
class PhoneNumberAdmin(admin.ModelAdmin):
    list_display = ["id", "twilio_account", "phone_number", "is_default"]
    search_fields = ["twilio_account", "phone_number", "is_default"]

@admin.register(Contact)
class ContactAdmin(admin.ModelAdmin):
    list_display = ["id", "twilio_account", "name", "phone", "email"]
    search_fields = ["twilio_account", "name", "phone", "email"]

@admin.register(Conversation)
class ConversationAdmin(admin.ModelAdmin):
    list_display = [
        "id", "twilio_account", "contact", "last_message", "last_sender", "last_message_time", 
        "last_read_time", "is_read", "created_at", "updated_at",
    ]
    search_fields = [
        "twilio_account", "contact", "last_message", "last_sender", "last_message_time", 
        "last_read_time", "is_read", "created_at", "updated_at",
    ]
...
class MessageAdmin(admin.ModelAdmin):
    ...
    search_fields = [ "conversation", "sender", "sms_sid", 'from_number', 'to_number', "text", "status", "created_at", 'updated_at' ]
